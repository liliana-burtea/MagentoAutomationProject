...
public class Constants {
    ...
    // public = ofer vizibilitate in alte clase
    // static = ofera acces folosind numele clasei
    // final = transforma o variabila in constanta
    // Denumirea de constanta este doar cu litere mari si poate folosi undrscore
    ...
    public static final String LIGHT_BLUE_COLOR = "rgb(0, 173, 226)";
